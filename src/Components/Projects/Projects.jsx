...
//       figma: "https://www.figma.com/proto/example1", // 🔗 Add your real project URL
//     },
//     {
//       id: 2,
...
//     <section
//       ref={sectionRef}
//       className="py-section-py px-section-px bg-primary"
//     >
...
//           <h2
//             ref={titleRef}
//             className="text-4xl md:text-5xl lg:text-6xl font-light text-secondary opacity-0"
//           >
//             Selected Works
//           </h2>
//           <div
//             ref={lineRef}
//             className="w-0 h-1 bg-gradient-to-r from-accent to-primary-hover mx-auto mt-4 opacity-0"
//           ></div>
//           <p
//             ref={paraRef}
//             className="text-lg md:text-xl lg:text-2xl text-secondary-hover mt-6 max-w-2xl mx-auto leading-relaxed opacity-0"
//           >
...
//               className="relative w-80 h-90 md:w-96 md:h-90 sm:w-full rounded-xl overflow-hidden shadow-lg"
//             >
//               <img
